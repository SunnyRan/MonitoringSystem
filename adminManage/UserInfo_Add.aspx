<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserInfo_Add.aspx.cs" Inherits="UserInfo_add" %>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="daohanglink" style="">
                            <span class="daohang"></span><span>首页&gt;</span> <span>用户信息管理&gt;</span> <span>添加用户信息</span>
                        </div>
                        <div id="attachment" class="well brown">
                            <div class="form_list">
                                <label class="lable_title">
                                    登录账户：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_Name" runat="server" Width="309px"></asp:TextBox>
                            </div>
                            <div class="form_list">
                                <label class="lable_title">
                                    用户名称：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_RealName" runat="server" Width="309px"></asp:TextBox>
                            </div>
                            <div class="form_list">
                                <label class="lable_title">
                                    登录密码：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_Pwd" runat="server" TextMode="Password" Width="309px" Height="33px"></asp:TextBox>
                            </div>
                            <div class="form_list">
                                <label class="lable_title">
                                    确认密码：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_PwdSure" runat="server" TextMode="Password" Width="309px" Height="33px"></asp:TextBox>
                            </div>
                            <div class="form_list">
                                <label class="lable_title">
                                    用户等级：
                                ...
                                <asp:RadioButtonList ID="Seletlevel" runat="server"
                                    RepeatDirection="Horizontal" RepeatLayout="Flow" Font-Size="X-Large">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassInfo_Manage.aspx.cs" Inherits="UserInfo" %>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style=" padding:10px;">
                                            <asp:Button ID="Button_Select" runat="server" class="submit" OnClick="Button_Select_Click" Width="50px" Height="35px"
                                                Text="查询" />
                                        </td>
                                        <td>

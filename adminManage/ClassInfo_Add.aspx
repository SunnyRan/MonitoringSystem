<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassInfo_Add.aspx.cs" Inherits="ClassInfo_add" %>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="daohanglink" style="">
                            <span class="daohang"></span><span>首页&gt;</span> <span>类别信息管理&gt;</span> <span>添加类别信息</span>
                        </div>
                        <div class="well brown">
                            <div class="form_list">
                                <label class="lable_title">
                                    类别名称：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_ClassName" runat="server" Width="309px"></asp:TextBox>
                            </div>
                            <div class="form_list">
                                <label class="lable_title">
                                    类别排序：</label>&nbsp;&nbsp;
                                <asp:TextBox ID="TextBox_Sort" runat="server" Width="309px" onkeyup="value=value.replace(/[^\d]/g,'')"
                            ...
                            <div class="form_list">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButtonList ID="Seletlevel" runat="server"
                                    RepeatDirection="Horizontal" Height="16px" Width="164px" RepeatLayout="Flow">
